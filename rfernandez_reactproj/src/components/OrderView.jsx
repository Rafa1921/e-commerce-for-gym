        ...
        <div className='grid grid-cols-1 md:grid-cols-70/30 w-full gap-6'>
          ...
          <aside>
            ...
            <div className='bg-white p-6 rounded-lg shadow-md'>
              ...
              <div className='grid grid-cols-2 md:grid-cols-2 gap-1 text-xl '> <span className='font-bold'>Address: </span><span className='text-sm'>1234 Tandang Sora Ave., Quezon City 1890</span></div>
              <div className='grid grid-cols-2 md:grid-cols-2 gap-1 text-xl mb-10'> <span className='font-bold'>Phone: </span><span className='text-sm'>+639123456789</span></div>
