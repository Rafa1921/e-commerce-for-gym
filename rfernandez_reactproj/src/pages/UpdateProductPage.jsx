      ...
      <div className='container m-auto max-w-2xl py-24'>
        <div className='bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0 content-center'>
          ...
          <div className='flex justify-center'>
            ...
            <input class="block w-full text-sm mb-20 text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-white" id="file_input" type="file" onChange={setImage} />
